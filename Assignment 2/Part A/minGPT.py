...
def train():
    ...
    test_dataset = TranslationDataset(test_pairs, lang, MAX_LENGTH)
    ...
    train_config.learning_rate = 6e-5  # 降低学习率
    train_config.max_iters = 5000     # 增加训练次数
...
# %%
test_cases = [
    ("全民制作人大家好。", "Hello everyone, all the national producers."),
    ("我是练习时长两年半的个人练习生。", "I am an individual trainee with two and a half years of practice."),
    ("喜欢唱、跳、rap、篮球。", "I like singing, dancing, rap, and basketball."),
    ("只因你太美。", "It's all because of you are so beautiful."),
    ("哎呦，你干嘛。", "Aiyo, what are you doing?"),
    ("哇真的是你啊。", "Wow, it's really you."),
    ("巅峰迎来虚伪的拥护。", "The peak welcomes hypocritical support."),
    ("黄昏见证真正的信徒。", "Dusk witnesses true believers.")
]
